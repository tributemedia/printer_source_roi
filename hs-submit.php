...
$str_post = "firstname=" . urlencode($first_name)
  ...
  . "&purchase_daily_savings=" . urlencode($pur_daily_savings)
  . "&purchase_monthly_savings=" . urlencode($pur_monthly_savings)
  . "&purchase_yearly_savings=" . urlencode($pur_yearly_savings)
  . "&roi_time_frame=" . urlencode($roi_time_frame)
  . "&monthly_lease_cost=" . urlencode($monthly_lease_cost)
  . "&lease_monthly_savings=" . urlencode($lease_monthly_savings)
